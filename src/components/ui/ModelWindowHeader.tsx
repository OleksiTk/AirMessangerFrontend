...
function ModelWindowHeader({
  isOpenModelWindow,
  setIsOpenModelWindow,
}: {
  isOpenModelWindow: boolean;
  setIsOpenModelWindow: (value: boolean) => void;
}) {
  ...
  function HabdleModalWindow() {
    if (modalWindow == true) {
      ...
      setIsOpenModelWindow(false);
    } else {
      setModalWindow(true);
      setIsOpenModelWindow(true);
    }
  }
    ...
    <div className="modal-window">
      <div className="modal-window__switcher">
        <div className="modal-window__switcher-buttons">
          ...
          <div className="modal-window__switcher-close-buttons">
            {" "}
            <span
        ...
        {switcher == "Contacts" ? (
          <div className="modal-window__contacts">
            ...
            <div className="contacts-form">
              {findName.length > 0
                ? findName.map((user) => (
                    <div key={user.id} className="contacts-form__item">
                      <img
                        src={user.avatar}
...
export default ModelWindowHeader;
